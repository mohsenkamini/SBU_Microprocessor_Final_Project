...
changed by:					@mohsenkamini for STM32F4
...

{
	...
	*/	
	...
	HAL_GPIO_WritePin(KeypadStruct.OUT1_Port, KeypadStruct.OUT1pin, GPIO_PIN_RESET);

	HAL_GPIO_WritePin(KeypadStruct.OUT2_Port, KeypadStruct.OUT2pin, GPIO_PIN_RESET);

	HAL_GPIO_WritePin(KeypadStruct.OUT3_Port, KeypadStruct.OUT3pin, GPIO_PIN_RESET);
	...
	*/	
	HAL_GPIO_WritePin(KeypadStruct.OUT0_Port, KeypadStruct.OUT0pin, GPIO_PIN_RESET);
...
int Keypad4x4_GetInt(uint8_t keypadSw)

{

	return keypadIntKeys[keypadSw];
